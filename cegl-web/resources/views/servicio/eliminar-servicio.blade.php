<!-- Agregar Modal -->
<div class="modal fade" id="eliminarservicio" tabindex="-1" role="dialog" aria-labelledby="exampleModalTitle"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('eliminarServicio')}}" method="post" enctype="multipart/form-data">
          @csrf
          <!--Cuerpo-->
